window.addEventListener('load', ()=>{
    ...
    box.innerHTML += `<h4 class="main-sw__subtitle">Zamień liczby dziesiętne (10) na liczby binarne (2)</h4>`
    for(let i = 0; i < 5; i++) {
        box.innerHTML += `
        <div class="excersize__box">
            <div>
                <p><span id="id${i}value">${numbers[i]}</span><sub>(10)</sub></p>  
                <input type="number" id="id${i}input" placeholder="wartość (2)">
    ...
    box.innerHTML += `<h4 class="main-sw__subtitle">Zamień liczby binarne (2) na liczby dziesiętne (10)</h4>`
    for(let i = 5; i < 10; i++) {
